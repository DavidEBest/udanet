...
_PERSONMESSAGELIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='people', full_name='PersonMessageList.people', index=0,
...
_PERSONMESSAGELIST.fields_by_name['people'].message_type = _PERSONMESSAGE
