...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Search = channel.unary_unary(
                ...
                request_serializer=location__pb2.LocationSearchParams.SerializeToString,
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Search': grpc.unary_unary_rpc_method_handler(
                    servicer.Search,
                    request_deserializer=location__pb2.LocationSearchParams.FromString,
...
class LocationService(object):
    ...
    def Search(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/LocationService/Search',
            location__pb2.LocationSearchParams.SerializeToString,
