...
### My Updates
There were no significant changes to the external facing parts of the UdaConnect application. I modified the existing monolithic app into an API gateway. The new backend could be run against the sample front end application with no changes.
