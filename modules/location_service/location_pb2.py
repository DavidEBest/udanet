...
_LOCATIONSEARCHPARAMS = _descriptor.Descriptor(
  name='LocationSearchParams',
  full_name='LocationSearchParams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='person_id', full_name='LocationSearchParams.person_id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='meters', full_name='LocationSearchParams.meters', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_date', full_name='LocationSearchParams.start_date', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end_date', full_name='LocationSearchParams.end_date', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['LocationSearchParams'] = _LOCATIONSEARCHPARAMS
...
LocationSearchParams = _reflection.GeneratedProtocolMessageType('LocationSearchParams', (_message.Message,), {
  'DESCRIPTOR' : _LOCATIONSEARCHPARAMS,
  '__module__' : 'location_pb2'
  # @@protoc_insertion_point(class_scope:LocationSearchParams)
  })
_sym_db.RegisterMessage(LocationSearchParams)
...
_LOCATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Search',
    full_name='LocationService.Search',
    index=2,
    containing_service=None,
    input_type=_LOCATIONSEARCHPARAMS,
